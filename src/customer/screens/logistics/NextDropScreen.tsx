      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.statusBannerContainer}>
          <View style={styles.statusBanner}>
            <Icon name="local-shipping" size={16} color={colors.onSecondaryContainer} />
          ...
          <View style={styles.actionsContainer}>
            ...
            <View style={styles.secondaryActions}>
              <Pressable
                ...
                accessibilityRole="button"
              >
                <Icon name="phone" size={18} color={colors.onSecondaryContainer} />
              ...
              <Pressable
                ...
                accessibilityRole="button"
              >
                <Icon name="chat-bubble-outline" size={18} color={colors.onSecondaryContainer} />
