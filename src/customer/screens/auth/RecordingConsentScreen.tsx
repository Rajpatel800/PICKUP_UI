      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            <View style={styles.iconContainer}>
              <Icon name="videocam" size={24} color={colors.onPrimaryContainer} />
            </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.statusBox}>
            <View style={styles.statusLeft}>
              <Icon name="map" size={24} color={colors.onSurfaceVariant} />
              <View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.unavailableBox}>
            <Icon name="videocam-off" size={24} color={colors.onSurfaceVariant} style={{ marginTop: 2 }} />
            <View style={{ flex: 1 }}>
        ...
        <View style={styles.gridContainer}>
          <View style={styles.smallCard}>
            <View style={styles.smallIconAccepted}>
              <Icon name="check" size={20} color={colors.onSecondaryContainer} />
            </View>
            <View style={{ flex: 1 }}>
          ...
          <View style={styles.smallCard}>
            <View style={styles.smallIconStopped}>
              <Icon name="check-box-outline-blank" size={16} color={colors.onSurfaceVariant} />
            </View>
            <View style={{ flex: 1 }}>
