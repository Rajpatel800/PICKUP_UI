  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      <View style={styles.header}>
        ...
        >
          <Icon name="help-outline" size={24} color={colors.onSurfaceVariant} />
        </Pressable>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.infoBanner}>
            <Icon name="info-outline" size={16} color={colors.onErrorContainer} />
            <Text style={styles.infoBannerText}>Please select a vehicle to continue</Text>
          </View>

          <View style={styles.vehicleGrid}>
            <View style={styles.vehicleCard}>
              <Icon name="electric-rickshaw" size={24} color={colors.onSurfaceVariant} />
              <Text style={styles.vehicleLabel}>Auto</Text>
            </View>
            <View style={styles.vehicleCard}>
              <Icon name="local-taxi" size={24} color={colors.onSurfaceVariant} />
              <Text style={styles.vehicleLabel}>Cab</Text>
            </View>
            <View style={styles.vehicleCard}>
              <Icon name="airport-shuttle" size={24} color={colors.onSurfaceVariant} />
