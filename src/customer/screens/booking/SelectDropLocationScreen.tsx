...
import { reverseGeocode } from '../../../services/engine/geocoding';
      ...
      >
        ...
        <View style={styles.mapPinContainer} pointerEvents="none">
          <View style={styles.mapPin}>
            <Icon name="place" size={24} color={colors.onPrimary} />
          </View>
      ...
      <SafeAreaView edges={['bottom']} style={styles.bottomSheet}>
        ...
        <View style={styles.sheetContent}>
          ...
          <View style={styles.instructionsContainer}>
            <Icon name="edit" size={20} color={colors.onSurfaceVariant} style={styles.instructionsIcon} />
            <TextInput
