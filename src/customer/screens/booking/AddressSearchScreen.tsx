...
import { getCurrentPlace, LocationPermissionDeniedError, type PlaceSuggestion } from '../../../services/engine/geocoding';
          ...
          <View style={styles.searchInputWrapper}>
            ...
            {hasQuery && !isSearching && (
              <Pressable onPress={clear} style={styles.clearButton} accessibilityLabel="Clear search">
                <Icon name="cancel" size={20} color={colors.onSurfaceVariant} />
              </Pressable>
            )}
          </View>
        </View>
