          ...
          <View style={styles.bottomCard}>
            <View style={styles.statusHeader}>
              <Animated.View style={{ transform: [{ rotate: spin }] }}>
                <Icon name="loop" size={24} color={colors.primary} />
              </Animated.View>
            ...
            <View style={styles.scanningList}>
              ...
              <View style={styles.vehicleItem}>
                <Icon name="directions-car" size={28} color={colors.outline} />
                <Text style={styles.vehicleLabel}>AUTO</Text>
              </View>
              <View style={styles.divider} />
              <View style={styles.vehicleItem}>
                <Icon name="local-taxi" size={28} color={colors.outline} />
                <Text style={styles.vehicleLabel}>CAB</Text>
              </View>
              <View style={styles.divider} />
              <View style={styles.vehicleItem}>
                <Icon name="airport-shuttle" size={28} color={colors.outline} />
