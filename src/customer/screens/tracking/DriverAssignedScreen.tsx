...
import { getDriver } from '../../../services/engine/engine';
      ...
      <View style={styles.bottomSheetContainer}>
        ...
        <View style={styles.actionsContainer}>
          <Button
            ...
            variant="primary"
            fullWidth
            icon={<Icon name="call" size={20} color={colors.onPrimary} />}
          />
          <Button
            label="Trip Details"
            ...
            variant="secondary"
            fullWidth
            icon={<Icon name="list-alt" size={20} color={colors.onSecondaryContainer} />}
          />
        </View>
      </View>
    </View>
