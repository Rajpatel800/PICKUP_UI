          ...
          <View style={styles.statusBanner}>
            <View style={styles.statusBannerHeader}>
              <View style={styles.clockIconContainer}>
                <Icon name="access-time" size={14} color={colors.onSecondaryContainer} />
              </View>
          ...
          <View style={styles.driverCard}>
              ...
              <View style={styles.driverInfoLeft}>
                ...
                <View>
                  ...
                  <View style={styles.driverRatingPill}>
                    <Icon name="star-border" size={12} color={colors.onTertiaryContainer} />
            ...
            <View style={styles.communicationActions}>
              ...
              <Pressable
                ...
                accessibilityRole="button"
              >
                <Icon name="phone" size={20} color={colors.onSecondaryContainer} />
              </Pressable>
              ...
              <Pressable
                ...
                accessibilityRole="button"
              >
                <Icon name="chat-bubble-outline" size={20} color={colors.onSecondaryContainer} />
              </Pressable>
            </View>
