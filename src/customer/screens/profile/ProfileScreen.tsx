...
const MenuIcon: React.FC<{ readonly name: string }> = ({ name }) => (
  <Icon name={(name) as any} size={20} color={colors.onSurfaceVariant} />
);

const Chevron = () => (
  <Icon name="keyboard-arrow-right" size={20} color={colors.outlineVariant} />
);
