    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.paymentMethodRow}>
            <View style={styles.paymentMethodBadge}>
              <Icon name="credit-card" size={14} color={colors.onSurfaceVariant} />
          ...
          <View style={styles.driverRow}>
            ...
            <View style={styles.driverInfo}>
              ...
              <View style={styles.driverMeta}>
                ...
                <Icon name="star-border" size={12} color={colors.onSurfaceVariant} />
        ...
        <View style={styles.actionContainer}>
          ...
          >
            <Icon name="file-download" size={20} color={colors.onPrimary} />
          ...
          >
            <Icon name="help-outline" size={20} color={colors.onSurface} />
