...
import { getCurrentPlace, LocationPermissionDeniedError } from '../../../services/engine/geocoding';
import { getActiveTripForCustomer } from '../../../services/engine/engine';
import { toApiError } from '../../../services/engine/http';
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      <View style={styles.headerWrapper}>
        <TopAppBar
          ...
          trailingIcon={<Icon name="notifications" size={22} color={colors.primary} />}
      ...
      >
        ...
        >
          <Icon
            name={(nearbyError ? 'alert-circle' : 'truck') as any}
            size={12}
            color={
              nearbyError
                ? colors.error
        ...
        <View style={styles.activeTripOverlay}>
          ...
          >
            <View style={styles.tripContent}>
              ...
              <Icon name="keyboard-arrow-right" size={20} color={colors.onSurfaceVariant} />
            </View>
          </Card>
        </View>
      )}
                  ...
                  <Pressable style={styles.inputContentWrapper} onPress={() => navigation?.navigate('AddressSearchScreen')}>
                    <View style={styles.inputFieldRow}>
                      ...
                      <View style={styles.arrowCircle}>
                        <Icon name="arrow-forward" size={12} color={colors.onSurfaceVariant} />
                      </View>
                    </View>
                  </Pressable>
                </View>
              ...
              {mockRecentLocations.map((loc, index) => (
                <React.Fragment key={loc.id}>
                  ...
                  <ListRow
                    ...
                    leading={<Icon name="access-time" size={18} color={colors.onSurfaceVariant} />}
                    onPress={() => {
          ...
          <View style={styles.quickActionsGrid}>
            ...
            >
              <View style={styles.iconBadgeSecondary}>
                <Icon name="bookmark-border" size={20} color={colors.onSurfaceVariant} />
              </View>
              <View style={styles.actionTextWrapper}>
      ...
      <View style={styles.bottomTabBar}>
        ...
        <Pressable style={styles.tabItem} onPress={() => navigation?.navigate('TripHistoryScreen')}>
          <View style={styles.tabIconWrapper}>
            <Icon name="navigation" size={20} color={colors.onSurfaceVariant} />
          </View>
