      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statusCard}>
          <View style={styles.cancelIconBox}>
            <Icon name="cancel" size={40} color={colors.onErrorContainer} />
          </View>
        ...
        <View style={styles.infoSection}>
          <View style={styles.infoRow}>
            <Icon name="info-outline" size={20} color={colors.secondary} style={styles.infoIcon} />
        ...
        <View style={styles.summarySection}>
          ...
          <View style={styles.routeContainer}>
            <View style={styles.routeTimeline}>
              <Icon name="radio-button-checked" size={14} color={colors.primary} />
