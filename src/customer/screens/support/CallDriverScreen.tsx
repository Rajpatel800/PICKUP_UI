      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.topContext}>
          ...
          <View style={styles.avatarContainer}>
            ...
            <View style={styles.ratingBadge}>
              <Icon name="star-border" size={12} color={colors.primary} />
        ...
        <View style={styles.contextCards}>
          <View style={styles.contextCard}>
            <View style={styles.contextIconBox}>
              <Icon name="local-shipping" size={20} color={colors.onSurfaceVariant} />
            </View>
          ...
          <View style={styles.contextCard}>
            <View style={styles.contextIconBox}>
              <Icon name="location-on" size={20} color={colors.onSurfaceVariant} />
            </View>
            <View style={styles.contextTextContainer}>
        ...
        <View style={styles.bottomControls}>
          ...
          <View style={styles.privacyNote}>
            <Icon name="security" size={20} color={colors.primary} style={styles.privacyIcon} />
          ...
          <View style={styles.actionsContainer}>
            <View style={styles.secondaryActions}>
              ...
              >
                <View style={styles.callControlIconBox}>
                  <Icon name="mic-off" size={24} color={colors.onSurfaceVariant} />
                </View>
              ...
              <View style={styles.callControlBtn}>
                <View style={styles.callControlIconBox}>
                  <Icon name="grid-view" size={24} color={colors.onSurfaceVariant} />
                </View>
              ...
              >
                <View style={styles.callControlIconBox}>
                  <Icon name="volume-up" size={24} color={colors.onSurfaceVariant} />
                </View>
            ...
            >
              <Icon name="call-end" size={24} color={colors.onErrorContainer} />
