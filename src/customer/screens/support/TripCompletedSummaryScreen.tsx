    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.successBanner}>
          <Icon name="check-circle" size={24} color={colors.onSuccessContainer} />
        ...
        <View style={styles.actionContainer}>
          ...
          >
            <Icon name="star-border" size={20} color={colors.onPrimary} />
          ...
          >
            <Icon name="description" size={20} color={colors.onSecondaryContainer} />
