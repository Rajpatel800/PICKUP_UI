    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      >
          ...
          <View style={styles.headerTop}>
            ...
            <View style={styles.headerCenter}>
              ...
              <View style={styles.driverSubInfo}>
                ...
                <Icon name="star-border" size={12} color={colors.tertiary} />
        ...
        <ScrollView contentContainerStyle={styles.chatCanvas}>
          ...
          <View style={styles.systemMessageContainer}>
            <View style={styles.systemMessage}>
              <Icon name="navigation" size={14} color={colors.onSurfaceVariant} />
            ...
            <View style={styles.mediaBubbleRight}>
              <View style={styles.mediaContainer}>
                ...
                <View style={styles.uploadOverlay}>
                  <Icon name="loop" size={24} color={colors.onSurface} style={styles.spinIcon} />
          ...
          <View style={styles.messageRowRight}>
            ...
            <View style={styles.messageMetaRight}>
              ...
              <Icon name="access-time" size={14} color={colors.outline} />
            </View>
          </View>
        </ScrollView>
        ...
        <View style={styles.inputArea}>
          {onAttachFile ? (
            <Pressable style={styles.attachButton} onPress={() => onAttachFile()}>
              <Icon name="attach-file" size={24} color={colors.onSurfaceVariant} />
            </Pressable>
          ) : (
          ...
          <Pressable style={styles.sendButton} onPress={handleSend}>
            <Icon name="send" size={20} color={colors.onPrimary} style={{ marginLeft: -2, marginTop: 2 }} />
          </Pressable>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
